...
import img1 from '../assets/images/box-item/6.png'
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="page-title-heading mg-bt-12">
                                <h1 className="heading text-center">Create Posting</h1>
                            </div>
                         ...
                         <div className="col-xl-3 col-lg-6 col-md-6 col-12">
                            ...
                            <div className="sc-card-product">
                                ...
                                <div className="card-title">
                                    <h5><Link to="/item-details-01">Greenhouse Gas Reduction</Link></h5>
                                    <div className="tags">trx</div>
                                </div>
                                <div className="meta-info">
                                    <div className="author">
                                        <div className="info">
                                            <span>Owned By</span>
                                            <h6> <Link to="/author-02">Easy-A Hackathon Inc</Link></h6>
                                        </div>
                                    </div>
                                    <div className="price">
