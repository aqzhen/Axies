    ...
    const getWalletDetails = async () => {
        if (window.tronWeb) {
            if (window.tronWeb.ready) {
                let tempBalance = await connectTronWallet();
                setWalletText(tempBalance.address);
            }
        }
    }
                            ...
                            <div className="wrap-box flex">
                                ...
                                <div className="flat-search-btn flex">
                                    ...
                                    <div className="sc-btn-top mg-r-12" id="site-header">
                                        <button onClick={() => {
                                            getWalletDetails();
                                        }} className="sc-button header-slider style style-1 wallet fl-button pri-1"><span>{walletText}
                                        </span></button>
                                    </div>
